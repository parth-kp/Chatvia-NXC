    ...
    users: [
        ...
        { id : 0, name : "Patrick Hendricks", profilePicture : avatar2, status : "online", unRead : 0, roomType : "contact", isGroup: false, 
            messages: [
                ...
                { id: 9, message: "okay sure😄👍", time: "02:50 PM", userType: "sender", isImageMessage : false, isFileMessage : false },
        ] },
        ...
        { id : 6, name : "Steve Walker", profilePicture : avatar6, status : "away", unRead : 0,  isGroup: false,
            messages: [
                ...
                { id : 2, message : "Okay 👍, let me check it and get back to you soon", time : "01:16 PM", userType : "sender", isImageMessage : false, isFileMessage : false }
            ]  },
